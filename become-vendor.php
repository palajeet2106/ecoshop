...
include("header.php"); ?>
    ...
    <section class="seller-application product footer-padding">
        <div class="container">
            <div class="seller-application-section box-shadows">
                <div class="row ">
                    <div class="col-lg-7">
                        <div class="row gy-5">
                            <div class="col-lg-12">
                                        ...
                                        <div class="review-inner-form ">
                                            ...
                                            <div class="review-form-name checkbox">
                                                ...
                                                <label for="address" class="form-label">
                                                    I agree all terms and condition in EcoShop</label>
                                            </div>
                                            <div class="form-btn">
                                                <a href="create-account.php" class="shop-btn">Create Seller Account</a>
                                ...
                                <div class="col-lg-12">
                                    <div class="logo-wrapper">
                                        ...
                                        <div class="logo-upload">
                                            <img src="assets/images/homepage-one/upload.webp" alt="upload"
    ...
    <!--------------- seller-application-section-end---------------->
