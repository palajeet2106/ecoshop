                        ...
                        <tr class="cart-top">
                                ...
                                <div class="wrapper-data">
                                    ...
                                    <div class="wrapper">
                                        <div class="wrapper-img">
                                            <img src="assets/images/homepage-one/product-img/p-img-2.webp" alt="">
                                        </div>
                                        <div class="wrapper-content">
                                            <h5 class="wrapper-details">Eggs</h5>
                                            <div class="price">
                            ...
                            <td class="cart-center cart-item">
                                <div class="wrapper-data">
                                    ...
                                    <div class="wrapper">
                                        <div class="wrapper-img">
                                            <img src="assets/images/homepage-one/product-img/p-img-4.webp" alt="">
                                        </div>
                                        <div class="wrapper-content">
                                            <h5 class="wrapper-details">Beef Steak</h5>
                                            <div class="price">
                            ...
                            <td class="cart-center cart-item">
                                <div class="wrapper-data">
                                    ...
                                    <div class="wrapper">
                                        <div class="wrapper-img">
                                            <img src="assets/images/homepage-one/product-img/p-img-6.webp" alt="">
                                        </div>
                                        <div class="wrapper-content">
                                            <h5 class="wrapper-details">Mushrooms</h5>
                                            <div class="price">
