                                            ...
                                            <tr class="table-row ticket-row">
                                                <td class="table-wrapper wrapper-product">
                                                    <div class="wrapper">
                                                        ...
                                                        <div class="wrapper-content">
                                                            <h5 class="heading">Hot Chicken Patties</h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="table-wrapper">
                                            ...
                                            <tr class="table-row ticket-row">
                                                <td class="table-wrapper wrapper-product">
                                                    <div class="wrapper">
                                                        ...
                                                        <div class="wrapper-content">
                                                            <h5 class="heading">Fresh Banana</h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="table-wrapper">
                                            ...
                                            <tr class="table-row ticket-row">
                                                <td class="table-wrapper wrapper-product">
                                                    <div class="wrapper">
                                                        ...
                                                        <div class="wrapper-content">
                                                            <h5 class="heading">Orange Fruit</h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="table-wrapper">
                                            ...
                                            <tr class="table-row ticket-row">
                                                <td class="table-wrapper wrapper-product">
                                                    <div class="wrapper">
                                                        ...
                                                        <div class="wrapper-content">
                                                            <h5 class="heading">Organic Lemon Juice</h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="table-wrapper">
                                        ...
                                        <div class="product-wrapper">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="product-description">
                                                    <a href="product-sidebar.php" class="product-details">Bananas
                                                        Evidence-Based Health
                                                    </a>
                                                    <p class="paragraph">Didn't I tell you not put your phone on charge
                                                        because weekend?
                                                    </p>
                                                </div>
                                                <div class="product-cart-btn">
                                                    <a href="cart.php" class="product-btn">Edit Review</a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="product-wrapper">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="product-description">
                                                    <a href="product-sidebar.php" class="product-details">Orange Fruits
                                    ...
                                    <div class="col-md-6">
                                        <div class="product-wrapper">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="product-description">
                                                    <a href="product-sidebar.php" class="product-details">Lemon Juice
                                                        Can refresh your brain
                                                        is the source of vitamin C
                                                    </a>
                                                    <p class="paragraph">Didn't I tell you not put your phone on charge
                                                        because weekend?
                                    ...
                                    <div class="col-md-6">
                                        <div class="product-wrapper">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="product-description">
                                                    <a href="product-sidebar.php" class="product-details">Strawberry
                                                        Fruits
                                                    </a>
                                                    <p class="paragraph">Didn't I tell you not put your phone on charge
                                                        because weekend?
