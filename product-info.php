                                ...
                                <!-- <a href="#" class="shop-btn">
                                 ...
                                 <div class="product-cart-btn">
                                    <form method="post" action="function.php">
                                      ...
                                      <button type="submit" name="btnaddcart" class="shop-btn"> 
                                         Add To Cart
                                        </button>
                                    </form>
                                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Chicken Eggs
                                    </a>
                                    <div class="price">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="product-info.php" class="product-details">Fresh Watemelon
                                    </a>
                                    <div class="price">
