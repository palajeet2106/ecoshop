                ...
                <div class="swiper-wrapper hero-wrapper">
                    <div class="swiper-slide hero-slide">
                        <div class="hero-wrapper-slide wrapper-slide">
                            <div class="wrapper-info">
                                ...
                                <h2 class="wrapper-details">There's you can Buy your all of Grocery Products.
                                </h2>
                                <a href="#category" class="shop-btn">Shop Now
                                    <span>
                    ...
                    <div class="swiper-slide hero-slide">
                        <div class="hero-wrapper-slide wrapper-slide">
                            <div class="wrapper-info" data-aos="fade-right">
                                <span class="wrapper-subtitle">Fresh Grocery</span>
                                <h2 class="wrapper-details"> We Provide Fresh and Organic Fruits To Your Door.
                                </h2>
                                <a href="#category" class="shop-btn">Shop Now
                                    <span>
                                        <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="swiper-slide hero-slide">
                        <div class="hero-wrapper-slide wrapper-slide">
                            <div class="wrapper-info" data-aos="fade-right">
                                <span class="wrapper-subtitle">Fresh Grocery</span>
                                <h2 class="wrapper-details"> You Can Buy All the Grocery Items Hasslefree
                                </h2>
                                <a href="#category" class="shop-btn">Shop Now
                                    <span>
                                        <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<!--------------- category-section--------------->
<section class="product-category product" id = "category">
    <div class="container">
...
<section class="product fresh" >
    <div class="container">
        ...
        <div class="fresh-section">
            <div class="row g-5">
                <?php
                $rows = $db->ProductsDetailsByCategory('fashion');
                foreach($rows as $row){
                ?>
...
<section class="product fresh" >
    <div class="container">
        ...
        <div class="fresh-section">
            <div class="row g-5">
                <?php
                $rows = $db->ProductsDetailsByCategory('electronic');
...
<section class="product fresh">
    <div class="container">
        ...
        <div class="fresh-section">
            <div class="row g-5">
                <?php
                $rows = $db->ProductsDetailsByCategory('vegetables');
                foreach($rows as $row){
                ?>
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
...
<section class="product fresh juice-product">
    <div class="container">
        ...
        <div class="juice-product-section">
            <div class="row g-5">
                <?php
                $rows = $db->ProductsDetailsByCategory('juice');
                foreach($rows as $row){
                ?>
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
...
<section class="product fresh" >
    <div class="container">
        ...
        <div class="fresh-section">
            <div class="row g-5">
                <?php
                $rows = $db->ProductsDetailsByCategory('laptop');
                foreach($rows as $row){
                ?>
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
